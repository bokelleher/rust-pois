...
mod tests {
    use super::*;
    use crate::sesame::message::hex_decode;
    ...
    fn wrong_aad_rejected() {
        ...
        assert_eq!(open(&key, &iv, b"headers-B", &ct), Err(SesameError::DecryptFailed));
    }
    ...
    fn nist_gcm_known_answer() {
        ...
        assert_eq!(ct, expected, "AES-256-GCM ciphertext||tag must match NIST vector");
    }
}
