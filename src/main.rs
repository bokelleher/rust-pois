...
// mod websocket;
use std::sync::Arc;
// use websocket::{SignalBroadcaster, ws_handler, broadcast_signal};
...
use crate::password_change::change_password_handler;
...
async fn main() -> anyhow::Result<()> {
    ...
    //     let ws_registry = Arc::new(websocket::WsRegistry::new());
    ...
    let app = Router::new()
        ...
        .route("/monitor.html", get(serve_monitor))
...
async fn serve_monitor() -> impl IntoResponse {
    axum::response::Redirect::temporary("/static/monitor.html")
}
